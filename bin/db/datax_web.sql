...
-- ----------------------------
INSERT INTO `job_group` VALUES (1, 'datax-executor', 'data执行器', 1, 0, NULL);
...
CREATE TABLE `job_info`  (
  ...
  `job_json` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'data运行脚本',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `job_log`  (
  ...
  `process_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'data进程Id',
